...
В каждой клетке таблицы записана ровно одна из инструкций (например: none, read, write, sum, и т.п.). Каждый поток
...
> + ![O_work](https://latex.codecogs.com/svg.latex?O_{work}(..)) &mdash; общее количество инструкций
> + ![O_span](https://latex.codecogs.com/svg.latex?O_{span}(..)) &mdash; глубина инструкций
