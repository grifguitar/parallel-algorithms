...
> + **CRCW** (Concurrent Read Concurrent Write)
    > &space;&space; + common (при одновременной записи все потоки обязаны писать одно и то же)
    > &space;&space; + arbitrary (при одновременной записи, гонку данных выигрывает случайный поток)
    > &space;&space; + priority (при одновременной записи, гонку данных выигрывает поток с наименьшим номером)
