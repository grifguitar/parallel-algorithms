...
+ ![O_work](https://latex.codecogs.com/svg.latex?O_{work}(...)) &mdash; общее количество инструкций (время работы на
  одном потоке)
+ ![O_depth](https://latex.codecogs.com/svg.latex?O_{depth}(...)) &mdash; глубина инструкций (время работы на
  бесконечности потоков)
